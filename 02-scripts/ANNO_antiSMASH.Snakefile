...
#### SAMPLES ###################################################################
SAMPLES = {os.path.basename(fn).replace("-megahit.fasta.gz", ""): fn
           for fn in glob("/mnt/archgen/users/lutz/bachelorthesis_BGCs_Iwanska/04-analysis/assembly/snakemake/alignment/megahit/*-megahit.fasta.gz")}
################################################################################
